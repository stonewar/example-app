...
/**
 * Created by yandypiedra on 11.12.15.
 */
...
public class CircleTimerView extends View
{
    ...
    private static final int DEFAULT_CIRCLE_BUTTON_COLOR = 0xFFFA7777;
    private static final int DEFAULT_LINE_COLOR = 0xFFE9E2D9;
    private static final int DEFAULT_HIGHLIGHT_LINE_COLOR = 0xFF3F51B5;
...
//        canvas.drawColor(Color.RED);
        ...
        // Timer Text
        canvas.save();
        canvas.drawText(description, cx, cy + getFontHeight(timerNumberPaint) / 2 + gapBetweenTimerNumberAndText + getFontHeight
